...
export function VoucherDialog({ voucher, children }: VoucherDialogProps) {
    ...
    console.log('items raw', voucher.items);
console.log('items[0]', voucher.items[0]);
console.log('items[1]', voucher.items[1]);
console.log('items keys', Object.keys(voucher.items));
